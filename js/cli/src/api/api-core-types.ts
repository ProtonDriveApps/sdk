// @ts-nocheck — generated OpenAPI types; duplicates in upstream spec break tsc; consumers use `import type` only.
/**
...
export interface paths {
    ...
    '/core/{_version}/keys/user': {
        ...
        /**
         * Add new user key.
         * @description Add new user key by sending the encrypted PrivateKey and a value indicating whether the key should become
    ...
    '/core/{_version}/organizations/logo/{enc_id}': {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations['get_core-{_version}-organizations-logo-{enc_id}'];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ResetAuthDevicesInput: {
            AuthDeviceID: components['schemas']['Id2'];
        ...
        AddGroupMemberRequest: {
            ...
            GroupID: components['schemas']['Id2'];
            Email: string;
        ...
        ReplaceOrganizationKeysInput: {
             ...
             * @default null
             */
            AdminInvitations: components['schemas']['ReplaceOrganizationKeyInvitationDto'][];
            /**
             * @description Activate new key for all other non-private admins
             * @default null
             */
            AdminActivations: components['schemas']['ReplaceOrganizationKeyActivationDto'][];
        };
        ...
        MigrateOrganizationKeysInput: {
             ...
             * @default null
             */
            AdminInvitations: components['schemas']['MigrateOrganizationKeyInvitationDto'][];
            /**
             * @description Activate new key for all other non-private admins
             * @default null
             */
            AdminActivations: components['schemas']['MigrateOrganizationKeyActivationDto'][];
        };
        ...
        User: {
            ...
            Credit?: number;
            /**
             * @description 1: Proton (full), 2: Managed, 3: External
             * @example 0
             */
            Type?: number;
            /** @example 1654615966 */
        ...
        GroupResponse: {
            ...
            Name: string;
            Address: unknown[];
            Permissions: components['schemas']['GroupPermissions2'];
            CreateTime: number;
            Flags: components['schemas']['GroupFlags2'];
            Description?: string | null;
        };
        MemberInfo: Record<string, never>;
        ...
        VPNAuthenticationCertificateAdminTransformer: {
            /**
        ...
        GetMemberUnprivatizationOutput: {
            ...
            InvitationSignature?: components['schemas']['PGPSignature2'] | null;
            ...
            OrgKeyFingerprintSignature?: components['schemas']['PGPSignature2'] | null;
            /** @description Organization public key */
            OrgPublicKey?: components['schemas']['PGPPublicKey2'] | null;
        ...
        UserSettingsTransformer: {
            ...
            /**
             * @description Bitmap informing which client the user has logged in to. See ClientFlagBit
             * @example 1
             */
        ...
        EventInfo: {
            ...
            Calendars?: {
                ...
                /** @example 1 */
                Action?: number;
                Calendar?: components['schemas']['CalendarAugmentedTransformer'];
            }[];
            CalendarMembers?: {
                /** @example wSGAB7IOerWAaIItAfyAIbSWIaFSS== */
                ID?: string;
                /** @example 1 */
                Action?: number;
                Member?: components['schemas']['MemberTransformer'];
            }[];
            Pushes?: {
        ...
        ResetAuthDevicesUserKeyDto: {
            ID: components['schemas']['EncryptedId2'];
            PrivateKey: components['schemas']['PGPPrivateKey'];
        };
        /** @enum {integer} */
        GroupMemberType: 0 | 1;
        ...
        InternalGroupMembership: {
            ...
            /** Format: date-time */
            JoinTime?: string | null;
            TokenKeyPacket?: components['schemas']['BinaryString2'] | null;
            TokenSignaturePacket?: components['schemas']['BinaryString2'] | null;
            AddressSignaturePacket?: components['schemas']['BinaryString2'] | null;
            Group: components['schemas']['GroupMembershipGroup'];
        ...
        UserKeyInput: {
            PrivateKey: components['schemas']['PGPPrivateKey2'];
            OrgPrivateKey: components['schemas']['PGPPrivateKey2'];
            /** @example -----BEGIN PGP MESSAGE-----.*-----END PGP MESSAGE----- */
            OrgToken?: string;
        };
        ...
        ReplaceOrganizationKeyInvitationDto: {
            ...
            TokenKeyPacket: components['schemas']['BinaryString2'];
            Signature: components['schemas']['PGPSignature2'];
        ...
        PGPMessage2: string;
        /** @enum {integer} */
        GroupMemberType2: 0 | 1;
        /** @enum {integer} */
        GroupMemberState: 0 | 1 | 2 | 3 | 4;
        /** @enum {integer} */
        GroupMemberPermissions2: 0 | 1 | 2 | 3;
        /** @enum {integer} */
        GroupPermissions2: 0 | 1 | 2 | 3;
        /** @enum {integer} */
        GroupFlags2: 0;
        ...
        Filter: {
            /** @example Ik65N-aChBuWFdo1JpmHJB4iWetfzjVLNILERQqbYFBZc5crnxOabXKuIMKhiwBNwiuogItetAUvkFTwJFJPQg== */
            ID?: string;
            /** @example Updated */
            Name?: string;
            /** @example 1 */
            ...
            /** @example 1 */
            Priority?: number;
            /** @example require ["fileinto"]; if address :DOMAIN :is ["From", "Delivered-To"] "protonmail.ch" { fileinto "mylabel"; } else { keep; } */
            Sieve?: string;
            Tree?: {
                If?: {
                    Headers?: string[];
        ...
        CalendarAugmentedTransformer: {
             ...
             */
            Type?: 0 | 1;
            Members?: components['schemas']['MemberTransformer'][];
        };
        MemberTransformer: {
            /** @example wSGAB7IOerWAaIItAfyAIbSWIaFSS== */
            ID?: string;
        ...
        WalletOutput: {
             ...
             */
            PublicKey?: components['schemas']['BinaryString2'] | null;
        ...
        WalletAccountOutput: {
            ...
            Label: components['schemas']['BinaryString2'];
        ...
        WalletBitcoinAddressOutput: {
             ...
             * @example -----BEGIN PGP SIGNATURE-----...
             */
            BitcoinAddressSignature: components['schemas']['PGPSignature2'] | null;
            /**
        ...
        WalletTransactionOutput: {
            ...
            WalletID: components['schemas']['Id'];
            WalletAccountID: components['schemas']['Id'];
            TransactionID: components['schemas']['PGPMessage2'];
            /**
            ...
            /** @default null */
            HashedTransactionID: components['schemas']['BinaryString2'] | null;
            /** @default null */
            Label: components['schemas']['BinaryString2'] | null;
            /** @default null */
            ExchangeRate: components['schemas']['ExchangeRateOutput'] | null;
            /** @default null */
            Sender: components['schemas']['PGPMessage2'] | null;
            /** @default null */
            ToList: components['schemas']['PGPMessage2'] | null;
            /** @default null */
            Subject: components['schemas']['PGPMessage2'] | null;
            /** @default null */
            Body: components['schemas']['PGPMessage2'] | null;
        };
        ...
        ForwardingKeys: {
            PrivateKey?: components['schemas']['PGPPrivateKey2'] | null;
            ActivationToken?: components['schemas']['PGPMessage2'] | null;
        };
        /** @description An armored PGP Private Key */
...
export interface operations {
            ...
            content: {
                'application/json': {
                    ...
                    AddressKeys?: {
                        ...
                        Signature?: string;
                        SignedKeyList?: {
                            /** @example JSON.stringify([{"Fingerprint": "c93f767df53b0ca8395cfde90483475164ec6353","SHA256Fingerprints": ["164ec63...53c93f7", "f767d...f53b0c"],"Primary": 1,"Flags": 3}]) */
                            Data?: string;
                            /** @example -----BEGIN PGP SIGNATURE-----.*-----END PGP SIGNATURE----- */
                            Signature?: string;
                        };
            ...
            200: {
                ...
                content: {
                    'application/json': {
                        ...
                        Address?: {
                            /** @description Public key list for this address with metadata. First key is primary. */
                            Keys?: {
                                /**
                        ...
                        CatchAll?: {
                            /** @description Public key list for the catch-all address with metadata. First key is primary. */
                            Keys?: {
                                /**
                                 * @description Armored OpenPGP public key
                                 * @example -----BEGIN PGP PUBLIC KEY BLOCK-----.*-----END PGP PUBLIC KEY BLOCK-----
            ...
            content: {
                'application/json': {
                    ...
                    AddressKeys?: {
                        ...
                        SignedKeyList?: {
                            /** @example JSON.stringify([{"Fingerprint": "de90483475164ec6353c93f767df53b0ca8395cf","SHA256Fingerprints": ["164ec63...53c93f7", "f767d...f53b0c"],"Primary": 1,"Flags": 3}]) */
                            Data?: string;
                            /** @example -----BEGIN PGP SIGNATURE-----.*-----END PGP SIGNATURE----- */
                            Signature?: string;
                        };
            ...
            200: {
                ...
                content: {
                    'application/json': {
                        ...
                        ActiveVPNSessions?: components['schemas']['VPNAuthenticationCertificateAdminTransformer'][];
                        AuthenticationCertificates?: components['schemas']['VPNAuthenticationCertificateAdminTransformer'][];
                    };
                };
            };
        };
    ...
    'get_core-{_version}-organizations-logo-{enc_id}': {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    'get_core-{_version}-captcha': {
        parameters: {
            query: {
                ...
                Dark?: string | null;
                /** @example 1 */
                ForceWebMessaging?: Record<string, never>;
    ...
    'get_core-{_version}-settings-2fa-register': {
        parameters: {
            query?: {
                 ...
                 * @example true
                 */
                CrossPlatform?: Record<string, never>;
            };
            header?: never;
            path: {
                _version: string;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    'application/json': {
                        Code?: components['schemas']['ResponseCodeSuccess'];
                        /** @description will only appear with successful coupon token checks */
                        Plans?: (components['schemas']['Plan'] & {
                            /** @example 2 */
                            MaxTier?: number;
                            /** @example 1 */
    ...
    'get_core-{_version}-users-available': {
        parameters: {
            query?: {
                 ...
                 * @example 1
                 */
                ParseDomain?: Record<string, never>;
            };
            header?: never;
            path: {
                _version: string;
    ...
    'delete_core-{_version}-reports-bug-{ticketId}': {
        parameters: {
            query?: {
                RequesterID?: Record<string, never>;
                CreatedAt?: string;
    ...
    'get_core-v4-events-{id}': {
        parameters: {
            query?: {
                MessageCounts?: Record<string, never>;
                ConversationCounts?: Record<string, never>;
            };
            header?: {
            ...
            422: {
                ...
                content: {
                    'application/json': {
                        /** @example 2500 */
                        Code?: number;
                        /** @example Attribute Expanded should be of type int (float given) */
                        Error?: string;
                    };
                };
            };
